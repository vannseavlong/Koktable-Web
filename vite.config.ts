...
// The Figma Make environment generates .figma/make/site.json at runtime; it
// isn't committed, so fall back to an empty config when running standalone.
...
function figmaSiteConfiguration(config: FigmaSiteConfiguration): Plugin {
  ...
  const title = config.title ?? "KokTable"
